...
![Executive Overview](Retail_Dashboard_Page1.png)

### Page 2 — RFM Segments
![RFM Segments](Retail_Dashboard_Page2.png)

### Page 3 — Product Analysis
![Product Analysis](Retail_Dashboard_Page3.png)
...
│
├── Retail_Dashboard_Page1.png     # Dashboard screenshot — Executive Overview
├── Retail_Dashboard_Page2.png     # Dashboard screenshot — RFM Segments
├── Retail_Dashboard_Page3.png     # Dashboard screenshot — Product Analysis
│
└── README.md
```
